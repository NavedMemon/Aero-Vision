...
//                   🛫 {flightData.airline.name} Booking
//                 </h2>
//                 <div className="flight-info-box">
//                   <p>
//                     <strong>Flight:</strong> {flightData.flightNumber} <br />
...
// const stripePromise = loadStripe(
//   process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY ||
//     "pk_test_xxxxxxxxxxxxxxxxxxxxxxxx" // Fallback for debugging
// );
...
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({
//           amount: flightData.price * selectedSeats.length * 100, // Convert to paise
//           currency: "inr",
//           flightId: flightData.flightId,
//           seats: selectedSeats,
//           passengers: formData,
                ...
                <div className="booking-form-section">
                  ...
                  <div className="flight-info-box">
                    <p>
                      ...
                      <strong>Baggage:</strong> {flightData.baggageAllowance}{" "}
                      <br />
                      <strong>Gate:</strong> {flightData.gate} <br />
            ...
            <div className="modal-box ticket-modal-box">
              ...
              <div className="ticket-info">
                ...
                <p>
                  ...
                  <span
                    className={`booking-status ${
                      showTicket.flightStatus?.toLowerCase() || "on time"
                    }`}
                  >
                    {showTicket.flightStatus || "On Time"}
                  </span>
                </p>
                <p>
                  <strong>Seats:</strong>{" "}
